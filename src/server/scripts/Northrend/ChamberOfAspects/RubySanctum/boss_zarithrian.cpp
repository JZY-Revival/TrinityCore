...
class spell_intimidating_roar : public SpellScriptLoader
{
    public:
        spell_intimidating_roar() : SpellScriptLoader("spell_intimidating_roar") { }
		private:
            std::list<Unit *> playerList;
		
		class spell_intimidating_roar_SpellScript : public SpellScript
		{
			PrepareSpellScript(spell_intimidating_roar_SpellScript);
			...
			void Register()
			{
				OnEffectHit += SpellEffectFn(spell_intimidating_roar_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
				OnHit += SpellHitFn(spell_intimidating_roar_SpellScript::HandleOnHit);
			}
		};
		SpellScript* GetSpellScript() const
		{
			return new spell_intimidating_roar_SpellScript();
		}
		
		class spell_intimidating_roarAuraScript : public AuraScript
        {
            PrepareAuraScript(spell_intimidating_roarAuraScript);
			...
			void Register()
            {
				AfterEffectApply += AuraEffectApplyFn(spell_intimidating_roarAuraScript::HandleAfterEffectApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
				AfterEffectRemove += AuraEffectRemoveFn(spell_intimidating_roarAuraScript::HandleAfterEffectRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
			}
        ...
        {
            return new spell_intimidating_roarAuraScript();
        }
};
